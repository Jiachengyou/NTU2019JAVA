...
public class GamePannel extends JPanel {
	...
	public void drawbox() {
		for (int i = 1; i < leveli; i++) {
			for (int j = 1; j < levelj; j++) {
				switch (boxvalue[i][j]) {
				case 0:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/greenball.png")));
					break;
				case 1:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/redball.png")));
					break;
				case 2:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/blueball.png")));
					break;
				case 3:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/blackball.png")));
					break;
				case 4:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/pinkball.png")));
					break;
				case 22:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/graybox.png")));
					break;
				case 23:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/greenbox.png")));
					break;
				case 24:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/brownbox.png")));
					break;
				case 25:
					box[i][j].setIcon(new ImageIcon(getClass().getResource("img/yellowbox.png")));
					break;
				default:
	...
	public int wincheck(int i, int j) {
		if (boxvalue[i][j] == 23) {
			...
			if (levelno == 2) {
				JOptionPane.showMessageDialog(null, "wait for more...");
			}
		}
		return 0;
	}
	...
	public void updateBall() {
		...
		LevelLabel.setText("Your level : " + str2);
		BallLabel.setText("Current Ball is :- " + str);
	}

	public void showInfo() {
		String str = "1) W A S D mean \u2191 \u2190 \u2193 \u2192 \n"
				+ "2) SPACE switchs the ball.\n"
				+ "3) Win: Reaching green box\n";
		JOptionPane.showMessageDialog(null, str, "Relu", HEIGHT);
	}
	public void showInfo3() {
		String str = "version: 2.0\n"
				+ "histroy:\n"
				+ "1.0 init\n"
				+ "1.1 update rule info\n"
				+ "1.2 update bgi and icon\n"
				+ "2.0 update level\n"
				+ "developer:Jia Chengyou\n"
				+ "StudentID: t08902109";
		JOptionPane.showMessageDialog(null, str, "version", HEIGHT);
	...
	private void initComponents() {
		...
		add(jButton3);
		jButton3.setBounds(720, 340, 90, 32);
		...
		LevelLabel = new JLabel("Your level: ");
		LevelLabel.setFont(new Font("Cantarell", 0, 18)); // NOI18N
		LevelLabel.setForeground(Color.white);
		add(LevelLabel);
		LevelLabel.setBounds(500, 20, 120, 32);

		// set label
		jLabel1 = new JLabel("Relax At NTU Library");
		...
		background_Image.setIcon(new ImageIcon(getClass().getResource("/pushbox/img/bgi.jpg"))); // NOI18N
	...
	private void jButton3ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		showInfo3();
		controlPannel.grabFocus();// TODO add your handling code here:
	}// GEN-LAST:event_jButton2ActionPerformed
